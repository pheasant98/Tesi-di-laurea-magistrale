...
\intro{In questo capitolo vengono presente le stime e i risultati ottenuti dai modelli Bradley-Terry (BTM) presentati nel Capitolo \ref{cap:BT}. Inoltre, sarà riportata l'applicazione del metodo  \emph{LASSO} con relativi risultati. Seguirà poi un analisi conclusiva sulle variabile esplicative alla luce dei risultati ottenuti.}\\
