...
Nella Figura \ref{fig:lambda2} è mostrato l'andamento delle prestazioni del modello su tutti i valori assunti dal parametro di tuning $lambda$ durante l'operazione di K-Fold Cross Validation..
\begin{figure}[htbp]
	\begin{center}
