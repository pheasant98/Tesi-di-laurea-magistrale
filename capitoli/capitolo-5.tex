...
La stima dei parametri soglia $\theta_1$ e $\theta_2$ è pari, rispettivamente a -1.113 e 1.113, mentre il parametro $\delta$ globale per tutte le squadre è salito a 0.27, con uno SE di 0.142. Nella Figura \ref{tab:BTC} e nella Tabella \ref{tab:BTC2} vengono riportate le stime delle abilità delle squadre con i relativi SE, QSE e QV, e le stime di ogni covariata sul modello con relativo SE.\\%stacca
