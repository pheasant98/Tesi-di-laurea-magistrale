...
\begin{equation}
	...
	\begin{cases}
		...
		5 & \text{se la squadra ospite batte la squadra in casa con due o più gol di scarto.}
	\end{cases}       
\end{equation}
...
\begin{sidewaysfigure} 
	\centering
	\begin{center}
		\includegraphics[height=13cm, width=23cm]{rank4.png}
...
\end{table}
Le stime dei parametri ottenute sono molto simili alle stime presentate nelle Tabelle \ref{tab:BTCL2} e \ref{tab:BTCL3}. Viene confermata la poca importanza della percentuale dei passaggi completi \texttt{PCmp\%}, del numero di passaggi tentati \texttt{PAtt}, del numero di tocchi nella trequarti di difesa \texttt{ToDef3rd} e della distanza percorsa con la palla \texttt{TotDist}.
