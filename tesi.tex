...
\input{capitoli/capitolo-2}             % Dati
\input{capitoli/capitolo-3}             % Analisi grafica
\input{capitoli/capitolo-4}             % Modello BT
\input{capitoli/capitolo-5}				% Risultati BT
\input{capitoli/capitolo-6}             % Modelli ML
\input{capitoli/capitolo-7}             % Modelli ML
\input{capitoli/capitolo-8}             % confronti 
\input{capitoli/capitolo-9}             % Conclusioni
\input{capitoli/capitolo-10}			
\input{capitoli/Appendice} %R
\input{capitoli/Appendice2} %Python
\appendix                               
